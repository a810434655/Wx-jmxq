...
module.exports = {
  ...
  selectPage: function ({ page, size, starName}){
    // console.log(page, size, starName)
    const data = { page, size, starName }
    return http.GET({ url: URL.dreamforum + '/index/star/selectPage', data })
  },
